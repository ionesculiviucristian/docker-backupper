...
def postgres(ftp: bool, ftp_only: bool, rsync: bool, rsync_only: bool) -> None:
    return Backupper[TypeConfigContainerPostgres].run_backupper(app, ftp, ftp_only, rsync, rsync_only, Postgres(app))
